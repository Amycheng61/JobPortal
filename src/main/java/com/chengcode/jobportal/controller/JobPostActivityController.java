...
import com.chengcode.jobportal.service.JobSeekerApplyService;
...
public class JobPostActivityController {
    ...
    public String gloabalSearch(Model model,
        ...
        if(!(authentication instanceof AnonymousAuthenticationToken)){
            ...
            if(authentication.getAuthorities().contains(new SimpleGrantedAuthority("Recruiter"))){
                ...
                List<JobSeekerSave> jobSeekerSaveList = jobSeekerSaveService.
                        getCandidatesJobByProfile((JobSeekerProfile) currentUserProfile);
                ...
                for(JobPostActivity jobPostActivity:jobPost){
                    ...
                    for(JobSeekerApply jobSeekerApply:jobSeekerApplyList){
                        if(Objects.equals(jobPostActivity.getPostedById(),jobSeekerApply.getJob().getPostedById())){
    ...
    public String addNew(JobPostActivity jobPostActivity,Model model){
        Users user = (Users) usersService.getCurrentUser();
        if(user !=null){
